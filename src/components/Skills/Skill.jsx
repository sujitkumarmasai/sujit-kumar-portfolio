...
import { SiRedux,SiNodedotjs,SiMongodb,SiExpress } from "react-icons/si";
            ...
            img: [
                {
                   // url: 'https://library.kissclipart.com/20180924/quq/kissclipart-node-js-logo-clipart-node-js-javascript-express-js-0cd102a8f7e1ebc8.jpg',
                    title1: 'Node.js',
                    url: <SiNodedotjs className="iconsDimensions"/>,
                },
                {
                   // url: 'https://www.opc-router.de/wp-content/uploads/2021/03/mongodb_thumbnail.png',
                    title1: 'MongoDB',
                    url: <SiMongodb className="iconsDimensions"/>,
                },
                // {
                ...
                // },
                {
                   // url: 'https://www.pngfind.com/pngs/m/136-1363736_express-js-icon-png-transparent-png.png',
                    title1: 'Express',
                    url: <SiExpress className="iconsDimensions"/>,
                },
            ],
...
// import ImportReactIconsCSS from "./ImportReactIcons.module.css";
// export const ImportReactIcons = () => {
//   const arr = [
//     {
//       icon: <FaHtml5 className={ImportReactIconsCSS.iconsDimensions} />,
//       title: "HTML5"
//     },
//     {
//       icon: <FaCss3Alt className={ImportReactIconsCSS.iconsDimensions} />,
//       title: "CSS3"
//     },
//     {
//       icon: <FaJsSquare className={ImportReactIconsCSS.iconsDimensions} />,
//       title: "JavaScript"
//     }
//   ];
